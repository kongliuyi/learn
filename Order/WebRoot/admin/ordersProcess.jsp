	...
	<div id="content">
		...
		<div id="breadcrumb">
			<a href="index.html" title="Go to Home" class="tip-bottom"><i
				class="icon-home"></i> 主页</a> <a href="#" class="current">待处理订单</a>
		</div>
		<div class="widget-box">
			...
			<div class="widget-content nopadding">
				<table class="table table-bordered table-striped">
					...
					<tbody>
						<s:iterator value="#session.processOrders" id="o">
							<tr>
								...
								<td><a class="btn btn-primary"
									href="javascript:if(confirm('确实菜肴已做好将进行发配吗?'))location='OrdersAction!Ship?id=<s:property value="#o.id"/>'" /><i
									class="icon-pencil icon-white"></i> 发货</a> <a
									class="btn btn-danger"
									href="javascript:if(confirm('确实要删除该订单吗?'))location='OrdersAction!myDel?str=<s:property value="#o.id"/>sb'"><i
